...
% Last Modified by GUIDE v2.5 19-Aug-2024 16:32:28
    ...
    gui_State = struct('gui_Name',       mfilename, ...
        ...
        'gui_OpeningFcn', @MarmoV7_OpeningFcn, ...
        'gui_OutputFcn',  @MarmoV7_OutputFcn, ...
        'gui_LayoutFcn',  [] , ...
        'gui_Callback',   []);
...
function MarmoV7_OpeningFcn(hObject, eventdata, handles, varargin)
    ...
    % This will change per protocol but is initialized here to track juice
    % delivered before starting a protocol
    ...
    UpdateEyeText(handles);  % A must contain the calibration data
...
function varargout = MarmoV7_OutputFcn(hObject, eventdata, handles)  %#ok<*INUSL>
...
function RunTrial_Callback(hObject, eventdata, handles)
    ...
    % Update parameter display again in case changes made after end trial
    updateParameterDisplay(handles);
